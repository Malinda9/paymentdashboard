...
const ALLOWED = new Set([
  ...
  'admin_users','admin_save_user','admin_toggle_user','admin_export_csv','admin_data_health'
]);
module.exports = async function handler(req,res){
  try{
    ...
    if(action==='login'){
      ...
      for(const k of ['id','rowNumber','username','active','query']) if(params[k]!==undefined) body[k]=params[k];
